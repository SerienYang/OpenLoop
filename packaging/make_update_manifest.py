...
uploads):
    ...
    OpenLoop-macos-arm64.app.tar.gz(.sig)     -> platforms["darwin-aarch64"]
    OpenLoop-macos-x64.app.tar.gz(.sig)       -> platforms["darwin-x86_64"]
    OpenLoop-windows-setup.exe(.sig)          -> platforms["windows-x86_64"]
...
The desktop app reads this file from the repository's
...
ARTIFACTS = {
    "OpenLoop-macos-arm64.app.tar.gz": "darwin-aarch64",
    "OpenLoop-macos-x64.app.tar.gz": "darwin-x86_64",
    "OpenLoop-windows-setup.exe": "windows-x86_64",
}
