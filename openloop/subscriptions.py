...
DM/channel (request↔reply, `[ol:id]`-correlated); a subscription brings a channel's messages IN
...
class ChannelBuffer:
    ...
    def __init__(self, cap: int = 50, state_path: Optional[Path] = None) -> None:
        ...
        self._names: dict[str, str] = {}  # channel address → display name ("#openloop-test")
...
def subscription_tools(
    ...
    *,
    ...
    """OpenLoop channel-subscription tools: subscribe / unsubscribe /
