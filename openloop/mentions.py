...
When @OpenLoop is tagged in a channel with no subscribed session, the router spawns a
new OpenLoop session that owns that thread and replies into it. This store is the
