...
token by a real API call (and returns the account identity to show back).
"""
...
class ConnectorDescriptor:
    ...
    # Chat-platform capability, narrower than two_way: sessions can subscribe to
    # connector channels (Sources > Channels, listening-sessions block).
    channels: bool = False
...
DESCRIPTORS: list[ConnectorDescriptor] = [
    ...
    ConnectorDescriptor(
        ...
        title="Slack",
        icon="💬",
        blurb="Two-way messaging through your own Slack app using Socket Mode.",
        auth="socket_app",
        two_way=True,
        channels=True,
        brand_color="#611f69",
    ...
    ConnectorDescriptor(
        ...
        fields=[],
        instructions=[
            "No setup required. Browser tools are available to OpenLoop sessions."
        ],
        available=True,
    ),
    ConnectorDescriptor(
    ...
    ConnectorDescriptor(
        ...
        available=True,
        # Key each connected mailbox by the email returned by token validation.
    ...
    # -- planned connectors (available=False) --------------------------------------
    # Planned connectors have no connect path until their implementation ships.
    ConnectorDescriptor(
        name="datadog",
        title="Datadog",
        icon="◍",
    ...
    ConnectorDescriptor(
        ...
        available=True,
        # Key each connected account by the Google identity returned by validation.
        account_field="@identity",
    ),
    ConnectorDescriptor(
        name="canva",
    ...
    ConnectorDescriptor(
        ...
        brand_color="#1f2328",
        logo="notion",
        # Manual integration tokens use the validated workspace identity.
...
# entirely (see packaging/openloop-server.spec). When the package is absent this is a no-op.
try:
