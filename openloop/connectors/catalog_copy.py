...
connector's actual tools (tool_defs.py) and the credentials the user supplies.
...
ABOUT: dict[str, str] = {
    "telegram": "Chat with OpenLoop from Telegram. Messages to your bot "
    "reach the agent and replies come back to the same chat — only senders on "
    "your allow-list get through.",
    "slack": "Bring OpenLoop into Slack: mention it in a channel or DM it, "
    "and replies land in-thread. The connected workspace has its own allow-list "
    "of who may talk to the agent.",
    ...
    "status through a personal access token scoped to the repositories you choose.",
    ...
    "update records. The private app controls access, and chosen properties can "
    "be hidden from agents entirely.",
...
ACCESS: dict[str, list[str]] = {
    ...
    "github": [
        ...
        "Access is limited by your personal access token.",
    ],
    "outlook": [
        "Reads and searches your mail.",
        "Sends mail as you.",
