...
DCR means there is no client id/secret registered anywhere up front, so this flow stays
fully local to OpenLoop and the vendor's authorization server.
