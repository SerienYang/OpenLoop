...
from ..agents import openloop_agent
...
class OpenLoopApp(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Input(placeholder="Ask OpenLoop…   (/help for commands)", id="prompt")
        yield Footer()
    ...
    def on_mount(self) -> None:
        ...
        self._write(
            f"[b]OpenLoop[/b]  ·  model {self.model}  ·  mode {self.mode.value}"
        )
