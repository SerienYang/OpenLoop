...
MATRIX: dict[str, ModelEntry] = {
    ...
    # OpenCode Go subscription catalog (official table checked 2026-08-06).
    # The gateway spans three wire protocols, but all routed IDs remain under one
    # provider prefix. Context/vision/PDF stay unset until independently verified.
    "opencode-go:grok-4.5": ModelEntry("Grok 4.5 · OpenCode Go"),
    "opencode-go:glm-5.2": ModelEntry("GLM-5.2 · OpenCode Go"),
    "opencode-go:glm-5.1": ModelEntry("GLM-5.1 · OpenCode Go"),
    "opencode-go:gpt-5.6-luna": ModelEntry("GPT-5.6 Luna · OpenCode Go"),
    "opencode-go:kimi-k3": ModelEntry("Kimi K3 · OpenCode Go"),
    "opencode-go:kimi-k2.7-code": ModelEntry("Kimi K2.7 Code · OpenCode Go"),
    "opencode-go:kimi-k2.6": ModelEntry("Kimi K2.6 · OpenCode Go"),
    "opencode-go:mimo-v2.5": ModelEntry("MiMo-V2.5 · OpenCode Go"),
    "opencode-go:mimo-v2.5-pro": ModelEntry("MiMo-V2.5-Pro · OpenCode Go"),
    "opencode-go:minimax-m3": ModelEntry("MiniMax M3 · OpenCode Go"),
    "opencode-go:minimax-m2.7": ModelEntry("MiniMax M2.7 · OpenCode Go"),
    "opencode-go:minimax-m2.5": ModelEntry("MiniMax M2.5 · OpenCode Go"),
    "opencode-go:qwen3.8-max": ModelEntry("Qwen3.8 Max · OpenCode Go"),
    "opencode-go:qwen3.7-max": ModelEntry("Qwen3.7 Max · OpenCode Go"),
    "opencode-go:qwen3.7-plus": ModelEntry("Qwen3.7 Plus · OpenCode Go"),
    "opencode-go:qwen3.6-plus": ModelEntry("Qwen3.6 Plus · OpenCode Go"),
    "opencode-go:deepseek-v4-pro": ModelEntry("DeepSeek V4 Pro · OpenCode Go"),
    "opencode-go:deepseek-v4-flash": ModelEntry("DeepSeek V4 Flash · OpenCode Go"),
    "opencode-go:hy3": ModelEntry("Hy3 · OpenCode Go"),
