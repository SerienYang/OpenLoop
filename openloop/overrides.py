...
**Inviolable rule: this store is user-local and only explicit user actions may write it.**
Runtime content and connector metadata cannot grant themselves lower risk.
"""
