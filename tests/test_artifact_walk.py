...
trips the App Data TCC protection and the user gets an alarming "OpenLoop would like to
...
from openloop.tools.search import OS_DATA_DIRS
...
def test_os_data_dirs_are_not_traversed(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("openloop.server.manager.os.walk", spy)
