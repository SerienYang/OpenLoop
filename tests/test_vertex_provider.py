...
from openloop.providers import capabilities_for
from openloop.providers.base import AssistantTurn, ProviderClient, StreamChunk
from openloop.providers.vertex_provider import VertexProvider, load_credentials
...
def test_api_key_method_builds_express_gemini_client(monkeypatch):
    ...
    from openloop.providers import GeminiProvider
...
def test_verify_vertex_api_key_method(monkeypatch):
    ...
    from openloop.providers.registry import verify_provider_key
...
def test_vertex_configured_needs_project_and_location():
    from openloop.providers.registry import descriptor_configured, get_descriptor
...
def _patch_verify(monkeypatch, creds: Any, status_code: Optional[int]):
    ...
    import openloop.providers.vertex_provider as vp
