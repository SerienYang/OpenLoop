...
from openloop.tools.files import file_tools
from openloop.tools.git import git_tools
from openloop.tools.search import _py_grep, search_tools
from openloop.web.fetch import _html_to_text, make_web_fetch_tool
...
def test_ripgrep_uses_the_same_ignored_dirs_as_the_python_fallback(tmp_path, monkeypatch):
    import openloop.tools.search as search
...
# -- OpenLoop agent wiring -----------------------------------------------------
def test_openloop_agent_has_search_git_and_multiroot_files(tmp_path):
