...
from openloop.providers.bedrock_provider import (
    BedrockProvider,
...
def test_claude_family_builds_native_anthropic_over_bedrock(monkeypatch):
    ...
    from openloop.providers import AnthropicProvider
...
def test_converse_client_publishes_api_key_as_bearer_env(monkeypatch):
    ...
    from openloop.providers.bedrock_provider import _BedrockConverseClient
