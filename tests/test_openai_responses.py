...
from openloop.providers.openai_responses import (
...
def test_basic_compatibility_complete_and_stream_send_only_standard_payload():
    ...
    complete_client = _FakeClient(response=_response([_message_item("ok")]))
    OpenAIResponsesProvider(
...
def test_registry_routes_blank_endpoint_to_responses():
    from openloop.providers import OpenAIProvider
