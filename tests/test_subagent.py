...
from openloop.permissions import Mode
...
from openloop.tools.subagent import build_explorer_engine, explorer_tools
...
def test_openloop_engine_registers_explore(tmp_path):
