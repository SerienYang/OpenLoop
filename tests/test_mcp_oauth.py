...
from openloop.mcp import oauth as mcp_oauth
from openloop.mcp.config import load_mcp_servers
...
def test_redirect_base_uses_openloop_port_only(monkeypatch):
    monkeypatch.setenv("OPENLOOP_PORT", "52341")

    assert mcp_oauth.redirect_base() == "http://127.0.0.1:52341"
