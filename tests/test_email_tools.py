...
from openloop.connectors.email_tools import (
...
from openloop.roots import RootDir
...
def test_connector_registration():
    ...
    from openloop.connectors.tool_defs import TOOLS_BY_CONNECTOR, connector_for_tool
