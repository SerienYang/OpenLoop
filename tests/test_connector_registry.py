"""Connector registry metadata and planned connector descriptors.
...
from openloop.connectors.descriptors import (
    ConnectorDescriptor,
    get_descriptor,
    list_descriptors,
)
...
_CATALOG_ENTRIES = ("github", "datadog", "salesforce", "hubspot", "pagerduty")
...
def test_placeholder_connectors_listed(tmp_path):
    ...
    # Every catalog entry has a descriptor + brand badge so the UI can render it.
