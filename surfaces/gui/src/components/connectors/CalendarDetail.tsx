...
// Accounts are added with a manually supplied OAuth access token.
  ...
  return (
    <div data-testid="gcal-detail">
      <div className="flex items-center gap-3.5 mb-5">
        <ConnectorBadge connector={c} size={44} title={t("Google Calendar")} />
      ...
      {!c.connected && (
        <div className={GRP}>
          <div className={ROW + " text-[12.5px] text-muted"}>
            {t("Paste a Google Calendar OAuth access token. Each account stays separate.")}
          </div>
        </div>
      )}
