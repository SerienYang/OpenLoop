...
describe("SkillsTab", () => {
  ...
  it("Add skill menu: three doors; Create with OpenLoop hands off to a conversation", async () => {
    ...
    fireEvent.click(screen.getByText("Create with OpenLoop"));
  ...
  it("the list is the page: no standing add-surfaces, no drafting remnants", async () => {
    ...
    expect(screen.queryByText("Ask OpenLoop to revise")).toBeNull();
