// Lightweight dependency-free i18n for the OpenLoop GUI.
//
// Design notes:
...
import { setTrayLanguage } from "./tauri";

export type Lang = "en" | "zh-CN";

const STORAGE_KEY = "openloop:lang";
...
export function translateDynamic(
  ...
  const translated = translate(key, lang, vars);
  const untranslated = interpolate(key, vars);
  return lang === "zh-CN" && translated === untranslated
    ? interpolate(zhFallback, vars)
    : translated;
}
